...
class ChatForm extends Component
{
    ...
    {                
        ...
        $this->mensaje = $this->faker->sentence;
    }
    
    // Cuando el otro componente nos solicita el usuario    
    ...
    // Se produce cuando se actualiza cualquier dato por binding, es decir al modificar las variables.
    //Esta validación se realiza en tiempo real en forma automática
    ...
    {                
        ...
        event(new \App\Events\MessageEvent($this->usuario, $this->mensaje));
