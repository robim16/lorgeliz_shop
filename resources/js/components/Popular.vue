...
<template> 
    <div class="lomasvendido owl-carousel owl-theme">
        <div class="owl-item" v-for="producto in productoPopular" :key="producto.id">
            <div class="product">
    ...
    export default {
        ...
        mounted() {
            ...
            window.Echo.channel('add-product').listen('AddProductEvent', (e) => {
                ...
                const index = this.productoPopular.findIndex(p => p.id == product.data.id);
            ...
            window.Echo.channel('producto-agotado').listen('ProductoAgotado', (e) => {
                ...
                Object.values(products).map(product => {
                    ...
                    if (index > -1) {
                        this.productoPopular.splice(index, 1);
                    }
                })
