...
@section('content')
                        ...
                        <tbody>
                            ...
                            @foreach ($clientes as $cliente)
                                <tr>
                                    ...
                                    <td> <a class="btn btn-primary btn-sm btn-icon"
                                            href="{{ route('cliente.show', $cliente->cliente->id) }}"
                                            title="ver cliente"><i class="fas fa-eye"></i></a></td>
                                    <td><a href="" class="btn btn-success btn-sm btn-icon" title="enviar mensaje"
    ...
    <div class="modal fade" id="modalMensaje" tabindex="-1" role="dialog" aria-labelledby="appModalLabel"
        aria-hidden="true">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response == true) {
                            ...
                            modal.find('.modal-body').html(
                                '<div class="alert alert-danger">Ha ocurrido un error al enviar el email</div>'
                                )
                        }
                    }
                });
