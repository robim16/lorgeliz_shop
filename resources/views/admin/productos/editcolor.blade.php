...
<div id="productos">
    ...
    <form action="{{ route('product.updateColor', $producto->slug)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        v-model="precioanterior" name="precioanterior" min="0" step=".01" disabled>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        v-model="precioactual" min="0" value="" step=".01" disabled>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor" name="descripcion_corta"
                                        id="descripcion_corta" rows="3" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor" name="descripcion_larga"
                                        id="descripcion_larga" rows="5" disabled>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor" name="especificaciones"
                                        id="especificaciones" rows="3" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor" name="datos_de_interes"
                                        id="datos_de_interes" rows="5" disabled>
                                    </textarea>
