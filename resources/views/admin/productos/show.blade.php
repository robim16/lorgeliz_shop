                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div id="barraprogreso" class="progress-bar" role="progressbar"
                                            ...
                                            aria-valuemin="0" aria-valuemax="100">@{{ porcentajededescuento }}%
                                        </div>
                                    </div>
                                    <!-- /.form-group -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                @foreach ($producto->colors as $product)
                                    @foreach (\App\Imagene::where('imageable_type', 'App\ColorProducto')->where('imageable_id', $product->pivot->id)->pluck('url', 'id')->take(1)
                                        as $id => $imagen)
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-primary float-right"
                                            href="{{ route('product.edit', $producto->id) }}">Editar</a>
