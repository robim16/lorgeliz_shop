                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-sm btn-icon"
                                            href="{{ route('tipo.show', $tipo->slug) }}" title="ver">
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-sm btn-icon"
                                            href="{{ route('tipo.edit', $tipo->slug) }}" title="editar">
                                    ...
                                    <td>
                                        <a class="btn btn-default btn-sm btn-icon" href="" title="agregar tallas"
                                            data-toggle="modal" data-target="#modalTallas" data-id="{{ $tipo['id'] }}"><i
                                                class="fas fa-plus"></i>
                                        </a>
                                    </td>
                                </tr>
