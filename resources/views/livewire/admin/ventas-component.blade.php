        ...
        <div class="card-tools">
            ...
            <form>
                ...
                <div class="input-group input-group-sm" style="width: 290px;">
                    ...
                    <select name="estado" id="estado" class="form-control float-right" style="width: 48px;" wire:model="estado">
                    ...
                    value="{{ request()->get('busqueda') }}" style="width: 60px;" wire:model="busqueda">
